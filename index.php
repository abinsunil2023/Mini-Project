...
<html lang="en">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <!-- <div class="loader"><img src="images/mg4.png" alt="#" /></div> -->
      </div>
      <!-- end loader -->
      <!-- header -->
      <header>
               ...
               <div class="row">
                  <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                     <div class="full">
                           ...
                           <h3 href="index.php">Constructor-Tech</h3>
                        
                     </div>
                  </div>
                  <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10">
                     <ul style="float:right" class="nav navigation navbar navbar-expand-md navbar-dark ">
                     ...
                     <li class="dropdown">
                        <a href="registration.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup= true aria-expanded= false>SignUp</a></button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                           <li><a class="dropdown-item" href="customer/registration.php">Customer</a></li>
                           <li><a class="dropdown-item" href="company/company_reg.php">Company</a></li>
                        </ul>
                     </li>
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           <div class="col-md-7">
                              <div class="text-bg">
                                 <h1> <span class="yellow"> CONSTRUCTOR </span> <br>TECH</h1>
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           <div class="col-md-7">
                              <div class="text-bg">
                                 <h1> <span class="yellow"> CONSTRUTOR </span> <br>TECH</h1>
                                 <p>For build your own dream.....  </p>
                                 <a class="read_more" href="#">Contact</a><a class="read_more" href="#">About Us</a>
                              </div>
                           </div>
                        </div>
         ...
         <div class="footer">
            <div class="container">
               <div class="row">
                  ...
                  <h3 href="index.php">Constructor-Tech</h3>
                     ...
                     <p>It is platform for find out your own dream home and put your concept about your future hime..., making it  </p>
                  </div>
                  <div class="col-md-3">
                     <div class="fid_box">
                        <h3>Useful Link </h3>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>Design by<a href="design"> Abin Sunil</a></p>
                     </div>
                  </div>
               </div>
            </div>
